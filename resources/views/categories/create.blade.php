            ...
            <div class="col-lg-8">
                <div class="card shadow-sm border-0 rounded-lg mt-4">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
                        <h4 class="mb-0">
                            <i class="bi bi-tag me-2"></i>Create New Category
                        </h4>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.category.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <div class="card border-dashed p-3">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <small class="text-muted mt-2">Upload a high-quality image (JPG, PNG, GIF)</small>
                                ...
                                <div class="form-check form-switch ps-0">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="form-check-label" for="is_active">
                                            {{ old('is_active', 1) ? 'Active (Visible to users)' : 'Inactive (Hidden from users)' }}
                                        </label>
                                    </div>
                                </div>
                            </div>
